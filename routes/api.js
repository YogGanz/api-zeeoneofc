...
loghandler = {
    notparam: {
        ...
        getApikey: 'Ga Punya Apikey Chat 6285813334446'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Apikey Invalid Chat Nomer 6285813334446'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'YogGanz') return res.json(loghandler.invalidKey)
...
if(apikeyInput != 'YogGanz') return res.json(loghandler.invalidKey)
if (!theme) return res.json(loghandler.nottheme)
if (theme != 'kertas' && theme != 'love') return res.json(loghandler.notheme)
if (!text) return res.json(loghandler.nottext)

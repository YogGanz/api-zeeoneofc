...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------JAYBOTz'+'JAYBOTz';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'JAYBOTz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'JAYBOTz') return res.json(loghandler.invalidKey)
